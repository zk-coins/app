...
MAPPING=(
  ...
  "07-amount-insufficient=e2e/07-send.spec.ts-snapshots/07-amount-insufficient-chromium-linux.png"
  "07-amount-invalid-text=e2e/07-send.spec.ts-snapshots/07-amount-invalid-text-chromium-linux.png"
  "07-amount-set-max-clicked=e2e/07-send.spec.ts-snapshots/07-amount-set-max-clicked-chromium-linux.png"
  "07-amount-typed=e2e/07-send.spec.ts-snapshots/07-amount-typed-chromium-linux.png"
  "07-confirm-cancel-back=e2e/07-send.spec.ts-snapshots/07-confirm-cancel-back-chromium-linux.png"
  "07-confirm-dialog-desktop=e2e/07-send.spec.ts-snapshots/07-confirm-dialog-desktop-chromium-linux.png"
  "07-confirm-dialog-mobile=e2e/07-send.spec.ts-snapshots/07-confirm-dialog-mobile-chromium-linux.png"
  "07-recipient-valid-hex=e2e/07-send.spec.ts-snapshots/07-recipient-valid-hex-chromium-linux.png"
  "07-send-default=e2e/07-send.spec.ts-snapshots/07-send-default-chromium-linux.png"
  "07-send-no-funds-banner=e2e/07-send.spec.ts-snapshots/07-send-no-funds-banner-chromium-linux.png"
  "07-send-success=e2e/07-send.spec.ts-snapshots/07-send-success-chromium-linux.png"
  ...
  "19-portfolio-empty=e2e/19-portfolio.spec.ts-snapshots/19-portfolio-empty-chromium-linux.png"
  "19-portfolio-funded-desktop=e2e/19-portfolio.spec.ts-snapshots/19-portfolio-funded-desktop-chromium-linux.png"
  "19-portfolio-funded-mobile=e2e/19-portfolio.spec.ts-snapshots/19-portfolio-funded-mobile-chromium-linux.png"
  "19-portfolio-loading=e2e/19-portfolio.spec.ts-snapshots/19-portfolio-loading-chromium-linux.png"
  ...
  "21-asset-detail-desktop=e2e/21-asset-detail.spec.ts-snapshots/21-asset-detail-desktop-chromium-linux.png"
  "21-asset-detail-loading=e2e/21-asset-detail.spec.ts-snapshots/21-asset-detail-loading-chromium-linux.png"
  "21-asset-detail-missing=e2e/21-asset-detail.spec.ts-snapshots/21-asset-detail-missing-chromium-linux.png"
  "21-asset-detail-mobile=e2e/21-asset-detail.spec.ts-snapshots/21-asset-detail-mobile-chromium-linux.png"
)
