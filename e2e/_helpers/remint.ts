 ...
 * surface it travelled through: the admit-time HTTP 4xx body from
 * `POST /v1/tx` (or the SDK/client wrapper) or a failed job's `error`
 * field — both embed the node message in the thrown `Error`'s message.
 */
