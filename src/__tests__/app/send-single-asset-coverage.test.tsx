/**
 * Coverage twin of send-single-asset — same fail-closed surface.
 */
...
describe('SendPage single-asset coverage — unavailable', () => {
  it('renders heading and unavailable body', () => {
    render(<SendPage />);
    expect(screen.getByTestId('send-heading')).toBeInTheDocument();
